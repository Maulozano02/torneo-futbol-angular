...
bootstrapApplication(AppComponent, {
  providers: [provideRouter(routes), provideHttpClient(), provideFirebaseApp(() => initializeApp({"projectId":"semanatec-682d1","appId":"1:754258830160:web:6d2b49316d947632130255","databaseURL":"https://semanatec-682d1-default-rtdb.firebaseio.com","storageBucket":"semanatec-682d1.appspot.com","apiKey":"AIzaSyD_wMl-1vAnu6tgc6nBtFNDapCx9jsymMA","authDomain":"semanatec-682d1.firebaseapp.com","messagingSenderId":"754258830160"})), provideAuth(() => getAuth()), provideFirestore(() => getFirestore()), provideAnimationsAsync('noop')] // Proporciona las rutas a la aplicación
